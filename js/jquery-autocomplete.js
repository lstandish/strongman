...
//            } else if (c === 13 || c === 39) { // enter or right arrow
            } else if (c === 13) { // enter or right arrow
                if (iHover !== -1) {
...
// mod by lgs to prevent html in cast from ruining match
// only use if cast only adds non-printed chars like html tags
...
// lgs corrected following line
            ...
            $.each(current, function (key, value) {
                var li = $(document.createElement("li")),
                    ...
                    i = count;
		var myactive = (cast(value).indexOf(': ')>0);
...
// lgs added myactive to disable selection of categories in list
		if (myactive) {
                li.hover(function () {
