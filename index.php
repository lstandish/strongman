...
<input type="checkbox" id="num" name="num" value="4" checked>&nbsp;0-9<br><input type="checkbox" id="symb" name="symb" value="8" checked>&nbsp;symb:<span style="line-height:90%;"> <small>!\&quot;#$%&amp;&apos;()*+,-./:;&lt;=&gt;?@[\]^_`{|}~</small></span><br>
